...
class InstaScraper:
    ...
    def login(self):
        ...
        self.fill_text(By.NAME, "username", USERNAME)
        ...
        not_now_button = wait(self.driver, 10).until(
            EC.element_to_be_clickable(((By.TAG_NAME, "button")[1]))
        )
    ...
    def scrape(self, page_namestring):
        ...
        self.login() if self.driver.find_elements(By.ID, "loginForm") else print(
            "already logged in"
        )
...
if __name__ == "__main__":
    ...
    scraper.scrape("ashokaconfessions_old")
